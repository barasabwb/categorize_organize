...
<section class="body">
    ...
    <div class="get_started_section w-full items-center h-full mt-10 pb-10" id="get_started_section">
        ...
        <div class="w-full text-center mt-4">
            <button class="bg-indigo-500 text-white py-2 px-4 rounded animate-bounce">Create an account now</button>
        </div>
