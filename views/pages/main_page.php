...
<div class="w-60 custom_scroll h-full shadow-md bg-white px-1 absolute font-sans overflow-y-auto">
  <div class="float-right text-sm mr-4">
    <button  data-bs-toggle="modal" data-bs-target="#add_category_modal" class="add_category_btn bg-blue-200 hover:bg-blue-500 hover:ring-1 hover:ring-blue-400 focus:bg-green-500 focus:ring-2 focus:ring-green-400 text-white py-1 px-2 transition duration-150 ease-in-out rounded-sm">Add</button>  
  </div>
  ...
  <ul class="relative mt-4" id="categories_sortable">
    <li class="relative">
      <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-100 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark">
...
<div class="block p-6 ml-64  h-full w-auto rounded-lg shadow-lg bg-white" >
